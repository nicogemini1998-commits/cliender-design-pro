...
const SAMPLE_CLIENTS = [
{
  ...
  contact: { name: "Toni Ureña", email: "toni@cliender.com", role: "Co-founder & Director Comercial" },
  ...
  voice: ["innovador", "directo", "experto", "cercano con clientes", "orientado a resultados"],
  toneTemperature: "Direct-premium (6/10 formal — profesional pero no corporativo)",
  audience: ["Empresas con budget marketing 3k-30k/mes", "Directores de Marketing PYME", "Fundadores que escalan", "Negocios que quieren IA en marketing"],
  contentPillars: [
  ...
  dont: ["clásico corporativo aburrido", "sobre-saturación de colores", "stock photos genéricas", "promesas sin métricas", "lenguaje excesivamente técnico"],
  cta: "Escala con IA",
  ...
  logo: {
    ...
    variants: ["violeta sobre negro (principal)", "blanco sobre violeta", "negro sobre blanco", "isotipo C standalone"],
    usage: "Zona seguridad = altura de la C. No usar sobre fondos con colores de más de 2 tonos. El isotipo C mínimo 32px."
  },
  // logoUrl: archivo OFICIAL del logo (Supabase). REGLA DE ORO — se compone como overlay
  // píxel-exacto sobre las generaciones; JAMÁS se le pide a la IA dibujarlo.
  ...
  references: ["hubspot.com", "semrush.com", "hootsuite.com"],
  visualReferences: {
    brands: ["HubSpot", "Semrush", "Later"],
    ...
    instagramRefs: ["@hubspot", "@semrush", "@later_media"],
  ...
  projects: 12, activeBoardId: null,
  verticals: ["SALES", "MEDIA", "TECH"],
  web: "cliender.com",
  _pinned: true,
  _color: "violet",
},
{
  ...
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#1A1A1A", "#ACCB46", "#878887", "#FFFFFF"],
  colorEmotion: "Verde lima vital sobre gris cálido: crecimiento humano y profesionalidad cercana",
  typography: { display: "Nexa", text: "Avenir", mono: "JetBrains Mono" },
  voice: ["profesional", "cercano", "transformador", "humano"],
  toneTemperature: "Cálido-profesional (6/10 formal)",
  audience: ["Directores de RRHH", "CEOs de PYME", "Responsables de formación"],
  contentPillars: ["Gestión del talento", "Cultura empresarial", "Liderazgo", "Empleabilidad"],
  compositionStyle: "Retratos corporativos cálidos, espacios de trabajo abiertos, diversidad real",
  dont: ["tecnicismos vacíos", "jerga corporativa", "promesas sin evidencia"],
  logo: { url: "", description: "Logo oficial (Manual de Identidad Corporativa): wordmark 'SAVIA' en gris #878887 con el símbolo de persona/brote en verde lima #ACCB46 reemplazando la V; 'FORMACIÓN' debajo en gris. Tipografía Nexa Bold (logo) + Avenir (texto). Variantes sobre blanco, negro, gris y verde.", shape: "Wordmark SAVIA + símbolo brote (persona) en la V + FORMACIÓN debajo. Ver Manual de Identidad en brand assets.", colors: { primary: "#ACCB46", secondary: "#878887", dark: "#1A1A1A" }, typography: "Nexa Bold (logo) + Avenir Black/Book (texto)", variants: ["color sobre blanco", "blanco sobre negro/verde", "símbolo brote standalone"], usage: "Colores oficiales: verde lima #ACCB46 (Pantone P 157-7 C) + gris #878887 (Pantone P 176-5 C). No usar verde bosque ni navy." },
  accent: "#ACCB46",
  bgGradient: "linear-gradient(135deg, #878887 0%, #ACCB46 100%)",
  references: ["savia (formación)"],
  visualReferences: {
    brands: ["Savia Formación"],
  ...
  projects: 8, activeBoardId: null,
  verticals: ["SALES","MEDIA"], web: "savia.es"
},
{
  id: "cl-beta",
  name: "Beta Formación",
  ...
  tagline: "Aprender para crecer",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#1A1A2E", "#E94560", "#0F3460", "#F5F5F5"],
  colorEmotion: "Rojo-azul dinámico: energía y ambición con profundidad académica",
  typography: { display: "Poppins", text: "Inter", mono: "JetBrains Mono" },
  voice: ["motivador", "accesible", "dinámico", "práctico"],
  toneTemperature: "Energético-accesible (4/10 formal)",
  audience: ["Jóvenes 18-30", "Desempleados en reconversión", "Profesionales que escalan"],
  contentPillars: ["Casos de éxito alumni", "Tips de productividad", "Noticias sector", "Tráiler de cursos"],
  compositionStyle: "Planos dinámicos, personas estudiando, colores contrastados, texto bold",
  dont: ["academicismo excesivo", "tecnicismos innecesarios", "pasividad"],
  logo: { url: "", description: "Logo 'β BETA FORMACIÓN': letra griega β vectorizada en rojo #E94560 como símbolo + wordmark en Poppins Bold. β tiene trazo redondeado grosor uniforme, 1.2u alto. Wordmark 0.7u alto. Fondo oscuro #1A1A2E variante principal.", shape: "β + wordmark. β: trazo redondeado, ratio 1:1.2. Wordmark a la derecha alineado centro.", colors: { primary: "#E94560", secondary: "#0F3460", background: "#1A1A2E" }, typography: "Poppins Bold para wordmark, β vectorial propio", variants: ["rojo sobre oscuro (principal)", "azul sobre blanco", "β isotipo standalone"], usage: "No usar β sobre fondos rojos. Zona seguridad = anchura de la β." },
  accent: "#E94560",
  bgGradient: "linear-gradient(135deg, #1A1A2E 0%, #E94560 100%)",
  references: ["domestika.org", "founderz.com", "ironhack.com"],
  visualReferences: {
    brands: ["Domestika", "Ironhack", "Founderz"],
    ...
    instagramRefs: ["@domestika", "@ironhack", "@founderz.school"],
  ...
  projects: 5, activeBoardId: null,
  verticals: ["SALES","MEDIA"], web: "betaformacion.es"
},
{
  id: "cl-ehei",
  name: "EHEI",
  ...
  tagline: "Excellence in European Higher Education",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#91475C", "#FFD878", "#4695BC", "#FFFFFF"],
  colorEmotion: "Vino y oro con azul: prestigio académico europeo con calidez institucional",
  typography: { display: "Playfair Display", text: "Source Serif", mono: "JetBrains Mono" },
  voice: ["institucional", "internacional", "riguroso", "aspiracional"],
  toneTemperature: "Formal-aspiracional (8/10 formal)",
  audience: ["Graduados universitarios", "Profesionales con Máster", "Perfil internacional 25-40"],
  contentPillars: ["Rankings y acreditaciones", "Experiencia campus", "Alumni network", "Convenios empresa"],
  compositionStyle: "Arquitectura europea clásica, retratos elegantes, composición simétrica",
  dont: ["informalidad", "abreviaciones", "lenguaje coloquial"],
  logo: { url: "", description: "Logo oficial EHEI (Logo.svg en brand assets): paleta vino #AD5369 / #91475C, oro #FFD878 y azul #4695BC sobre blanco. Iniciales 'EHEI' con wordmark 'European Higher Education Institute'.", shape: "Ver asset oficial Logo.svg en '00. CONTEXTO DEL CLIENTE/01. Marca y Brand Assets/Branding/'.", colors: { primary: "#FFD878", secondary: "#AD5369", accent: "#4695BC" }, typography: "Playfair Display (wordmark)", variants: ["logo color sobre blanco", "logo blanco sobre oscuro"], usage: "Usar colores oficiales del Logo.svg: vino, oro, azul. No sustituir por goldenrod/navy. Mínimo 40px ancho." },
  accent: "#FFD878",
  bgGradient: "linear-gradient(135deg, #91475C 0%, #4695BC 100%)",
  references: ["ie.edu", "esade.edu", "iese.edu"],
  visualReferences: {
    brands: ["IE Business School", "ESADE", "IESE"],
    ...
    instagramRefs: ["@ie.university", "@esade", "@iesebschool"],
  ...
  verticals: ["SALES","MEDIA","TECH"], web: "ehei.eu"
},
{
  id: "cl-integratec",
  ...
  tagline: "Formación online que funciona",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#16304f", "#36a9e1", "#5eb9a8", "#e74071"],
  colorEmotion: "Multicolor sobre navy: bloques azul, verde y magenta — tecnología accesible y dinámica",
  typography: { display: "Inter", text: "Inter", mono: "JetBrains Mono" },
  voice: ["claro", "eficiente", "tecnológico", "orientado a resultados"],
  toneTemperature: "Directo-eficiente (5/10 formal)",
  audience: ["Empresas que forman empleados online", "Responsables de formación B2B"],
  contentPillars: ["ROI de la formación", "Casos de cliente", "Demo plataforma", "Novedades FUNDAE"],
  compositionStyle: "Mockups digitales limpios, dashboards, iconografía tech, fondo navy con bloques de color",
  dont: ["promesas sin métricas", "complejidad innecesaria", "lenguaje pasivo"],
  logo: { url: "", description: "Logo oficial Integra Tec School (brand assets en Logos/LOGOS_ITS/): bloques de color sobre navy #16304f — azul #36a9e1, verde/teal #5eb9a8, magenta #e74071. Acentos secundarios naranja #f4a63d y morado #7d4fb8.", shape: "Ver assets oficiales en '00. CONTEXTO DEL CLIENTE/01. Marca y Brand Assets/Logos/LOGOS_ITS/' (logo_ITS_empleo.svg).", colors: { primary: "#36a9e1", secondary: "#5eb9a8", accent: "#e74071", dark: "#16304f" }, typography: "Inter", variants: ["logo color sobre blanco", "logo blanco (logo_ITS_empleo_BLANCO)"], usage: "Marca multicolor real: navy + azul + teal + magenta. No sustituir por azul Tailwind monocromo." },
  accent: "#36a9e1",
  bgGradient: "linear-gradient(135deg, #16304f 0%, #36a9e1 100%)",
  references: ["docebo.com", "talentlms.com", "360learning.com"],
  visualReferences: {
    brands: ["Docebo", "TalentLMS", "360Learning"],
    ...
    instagramRefs: ["@docebo", "@360learning", "@litmos"],
  ...
  verticals: ["SALES","TECH"], web: "formatel.es"
},
{
  id: "cl-garalma",
  name: "Garalma",
  initials: "GA",
  industry: "Inversiones / Inmobiliaria",
  tagline: "Soluciones que perduran",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#1C1C1E", "#FF6B35", "#FF9F1C", "#FFFCF2"],
  colorEmotion: "Naranja energía: proactividad, cercanía, resolución inmediata",
  typography: { display: "Montserrat", text: "Open Sans", mono: "JetBrains Mono" },
  voice: ["directo", "fiable", "cercano", "resolutivo"],
  toneTemperature: "Directo-cercano (4/10 formal)",
  audience: ["PYMES locales", "Autónomos", "Pequeños negocios"],
  contentPillars: ["Soluciones rápidas", "Testimonios cliente", "Proceso de trabajo", "Promoción estacional"],
  compositionStyle: "Planos de servicio real, antes/después, personas trabajando, calidez",
  dont: ["exceso de texto", "términos técnicos sin explicar", "ambigüedad"],
  logo: { url: "", description: "'GARALMA' en Montserrat ExtraBold caps naranja #FF6B35. La 'G' inicial lleva arco exterior vectorial (radio 120% cap-height) que sugiere movimiento. El arco es trazo 3pt, mismo naranja. La G-arco funciona como isotipo standalone. Sin sombras ni degradados.", shape: "Wordmark + isotipo integrado. G con arco exterior. Ratio total ~5.5:1.", colors: { primary: "#FF6B35", text: "#1C1C1E", warm: "#FF9F1C" }, typography: "Montserrat ExtraBold, caps, tracking 0.05em", variants: ["naranja sobre oscuro", "oscuro sobre blanco", "G-arco isotipo standalone"], usage: "El arco de G nunca se elimina. Isotipo mínimo 20px." },
  accent: "#FF6B35",
  bgGradient: "linear-gradient(135deg, #1C1C1E 0%, #FF6B35 100%)",
  references: ["sodexo.es", "securitas.es", "prosegur.com"],
  visualReferences: {
    brands: ["Sodexo", "Securitas", "ISS World"],
    contentStyle: "Servicios empresariales con calidez: planos de trabajo real en acción, uniformes branded en campo, testimonios de clientes satisfechos, resultados tangibles con antes/después",
    instagramRefs: ["@sodexo", "@securitas_ab", "@issworldservices"],
    videoStyle: "Día en la vida del equipo, testimonios breves de clientes reales, demostraciones de servicio en tiempo real, cifras de impacto sobre fondo naranja",
    shootingStyle: "Localizaciones reales de trabajo, luz natural o fluorescente de entorno, planos de acción con personas en movimiento, close-ups de detalles de calidad",
    avoid: "Escenas demasiado perfectas, stock genérico de servicios, promesas sin evidencia"
  },
  projects: 3, activeBoardId: null,
  verticals: ["TECH","MEDIA"], web: ""
},
{
  id: "cl-mvr",
  name: "Grupo MVR",
  ...
  tagline: "Crecimiento con estructura",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#111827", "#6366F1", "#818CF8", "#F9FAFB"],
  colorEmotion: "Indigo corporativo: visión estratégica, solidez, ambición controlada",
  typography: { display: "Inter", text: "Inter", mono: "JetBrains Mono" },
  voice: ["estratégico", "sólido", "ambicioso", "profesional"],
  toneTemperature: "Estratégico-formal (7/10 formal)",
  audience: ["Inversores", "Directivos de grupo", "Socios estratégicos B2B"],
  contentPillars: ["Resultados grupo", "Expansión y adquisiciones", "Talento directivo", "RSC"],
  compositionStyle: "Grafismo minimalista, datos protagonistas, fondos oscuros elegantes",
  dont: ["improvisación", "lenguaje informal", "promesas sin base"],
  logo: { url: "", description: "Monograma 'MVR' en Inter Bold: M y V comparten vértice central, R cierra a la derecha. Color indigo #6366F1 sobre dark #111827. Wordmark 'GRUPO MVR' en Inter Regular tracking 0.2em debajo del monograma, tamaño 0.4x. Geometría pura, sin decoración adicional.", shape: "Monograma cuadrado 1:1. MVR comparte vértice en punto de convergencia. Trazo 8% del ancho.", colors: { primary: "#6366F1", background: "#111827", soft: "#818CF8" }, typography: "Inter Bold (monograma) + Inter Regular tracking alto (wordmark)", variants: ["monograma sobre dark", "sobre blanco", "monograma+wordmark completo"], usage: "Mínimo 32px. El vértice compartido MV es crítico — no simplificar." },
  accent: "#6366F1",
  bgGradient: "linear-gradient(135deg, #111827 0%, #6366F1 100%)",
  references: ["berkshirehathaway.com", "blackrock.com", "kearney.com"],
  visualReferences: {
    brands: ["Berkshire Hathaway", "McKinsey", "BlackRock"],
    contentStyle: "Holding corporativo de alto nivel: data visualization elegante, gráficos de crecimiento sobre fondos oscuros, retratos de liderazgo ejecutivo, arquitectura de oficinas corporativas premium",
    instagramRefs: ["@mckinsey", "@blackrock", "@kearney"],
    videoStyle: "Informes de resultados animados, entrevistas a CEO/directivos en formato ejecutivo, hitos de expansión con mapas animados, cultura corporativa de alto rendimiento",
    shootingStyle: "Salas de juntas de cristal, fondos de ciudad desde planta alta, retratos con iluminación de estudio controlada, planos de documentos/datos en pantalla",
    avoid: "Informalidad, colores llamativos, lenguaje populista, imágenes de stock de apretones de manos"
  },
  projects: 7, activeBoardId: null,
  verticals: ["SALES","MEDIA"], web: ""
},
{
  id: "cl-innova",
  name: "Innova Humana",
  ...
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#000000", "#ff740e", "#545454", "#FFFFFF"],
  colorEmotion: "Naranja vibrante sobre negro y gris: energía, cercanía e innovación social",
  typography: { display: "League Spartan", text: "Montserrat", mono: "JetBrains Mono" },
  voice: ["cercano", "innovador", "comprometido", "humano"],
  toneTemperature: "Inspirador-cercano (5/10 formal)",
  audience: ["Personas en inclusión social y laboral", "Demandantes de empleo", "Desarrollo personal y profesional"],
  contentPillars: ["Formación para el empleo", "Orientación e inserción laboral", "Intervención social", "Casos de transformación"],
  ...
  dont: ["burocracia", "frialdad corporativa", "verde (no es color de marca)"],
  logo: { url: "", description: "Isologo oficial (Manual de Marca): símbolo 'iH' (H con i integrada formando una persona sentada) en naranja #ff740e + gris #545454, junto al wordmark 'INNOVA HUMANA' y bajada 'FORMACIÓN Y EMPLEO'. Tipografía League Spartan (display) + Montserrat (texto). Variantes sobre naranja, blanco, negro y gris.", shape: "Isologo iH (persona) + INNOVA (naranja) / HUMANA (gris) + FORMACIÓN Y EMPLEO. Ver Manual de Marca en brand assets.", colors: { primary: "#ff740e", secondary: "#545454", dark: "#000000" }, typography: "League Spartan (display) + Montserrat (texto)", variants: ["color sobre blanco/gris", "blanco sobre negro", "isotipo iH standalone"], usage: "Colores oficiales: naranja #ff740e + negro #000000 + gris #545454. NO usar verde. El isotipo iH puede ir solo." },
  accent: "#ff740e",
  bgGradient: "linear-gradient(135deg, #000000 0%, #ff740e 100%)",
  references: ["innova humana (formación y empleo)"],
  visualReferences: {
    brands: ["Innova Humana"],
  ...
  projects: 5, activeBoardId: null,
  verticals: ["SALES","MEDIA"], web: "innovahumana.es"
},
{
  id: "cl-inprogress",
  ...
  tagline: "Formación que te coloca",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#1A1A2E", "#F7931E", "#FDB913", "#FFFFFF"],
  colorEmotion: "Naranja-amarillo: energía juvenil, optimismo, empleabilidad directa",
  typography: { display: "Poppins", text: "Inter", mono: "JetBrains Mono" },
  voice: ["práctico", "motivador", "directo", "orientado al empleo"],
  toneTemperature: "Energético-práctico (3/10 formal)",
  audience: ["Jóvenes 16-25", "Buscan primer empleo", "Cambio de sector profesional"],
  contentPillars: ["Empleos conseguidos", "Salidas profesionales", "Becas y ayudas", "Día a día en clase"],
  compositionStyle: "Planos de taller real, herramientas, uniformes, jóvenes trabajando",
  dont: ["academicismo", "promesas vacías", "complejidad"],
  logo: { url: "", description: "Barra de progreso parcialmente rellena (50-70%, nunca 100%) como símbolo en naranja→amarillo degradado (#F7931E→#FDB913), radius 4pt. Wordmark 'INPROGRESS' en Poppins Bold caps + 'ESCUELA' en Poppins Regular tracking alto debajo. Concepto: siempre en progreso.", shape: "Barra 180x18pt. Relleno degradado H. Wordmark proporcional debajo o al lado.", colors: { primary: "#F7931E", gradient: "#F7931E a #FDB913", background: "#1A1A2E" }, typography: "Poppins Bold (INPROGRESS) + Poppins Regular tracking alto (ESCUELA)", variants: ["barra+wordmark horizontal", "barra encima wordmark", "solo barra progreso isotipo"], usage: "La barra nunca al 100% — siempre en progreso. Relleno mínimo 40%. No usar sin barra." },
  accent: "#F7931E",
  bgGradient: "linear-gradient(135deg, #1A1A2E 0%, #F7931E 100%)",
  references: ["ironhack.com", "thepowermba.com", "nuclio.school"],
  visualReferences: {
    brands: ["Ironhack", "The Power MBA", "Nuclio Digital School"],
    ...
    instagramRefs: ["@ironhack", "@thepowermba", "@nuclio.school"],
...
},
{
  ...
  tagline: "Tu defensa, nuestra misión",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#0D1117", "#B8860B", "#DAA520", "#F5F5DC"],
  colorEmotion: "Dorado + negro: autoridad, prestigio legal, sólida reputación",
  typography: { display: "Libre Baskerville", text: "Source Serif", mono: "JetBrains Mono" },
  voice: ["serio", "preciso", "confiable", "cercano"],
  toneTemperature: "Formal-tranquilizador (8/10 formal)",
  audience: ["Personas en proceso judicial", "Empresas con conflictos laborales", "Autónomos"],
  contentPillars: ["Derechos del ciudadano", "Consultas frecuentes", "Casos resueltos", "Cambios legislativos"],
  compositionStyle: "Interiores despacho serios, detalle documentos, profesionales en traje",
  dont: ["ambigüedad", "promesas de resultado", "lenguaje alarmista"],
  logo: { url: "", description: "Escudo hexagonal (base apuntada) con contorno dorado #DAA520 2pt, interior transparente/negro. Letra 'S' en Libre Baskerville Italic centrada dentro, dorado. Wordmark 'SAFE ABOGADOS': 'SAFE' en Libre Baskerville Bold dorado + 'ABOGADOS' en Source Serif Regular #F5F5DC tamaño 0.6x. Sin relleno sólido en el escudo.", shape: "Escudo hexagonal 1:1.3, vértice inferior agudo. S cap-height 60% del alto. Wordmark a la derecha alineado centro.", colors: { primary: "#DAA520", secondary: "#B8860B", background: "#0D1117", cream: "#F5F5DC" }, typography: "Libre Baskerville Italic (S + SAFE) + Source Serif Regular (ABOGADOS)", variants: ["escudo+wordmark horizontal", "solo escudo dorado", "crema sobre dark"], usage: "Escudo nunca relleno sólido. S siempre italic. Mínimo escudo 24px." },
  accent: "#DAA520",
  bgGradient: "linear-gradient(135deg, #0D1117 0%, #B8860B 100%)",
  references: ["perezllorca.com", "unalex.es", "deloitte.com/legal"],
  visualReferences: {
    brands: ["Pérez-Llorca", "Uría Menéndez", "Deloitte Legal"],
    ...
    instagramRefs: ["@perezllorca", "@uria_menendez", "@garrigues_abogados"],
  ...
  projects: 3, activeBoardId: null,
  verticals: ["SALES"], web: "safeabogados.es"
},
{
  id: "cl-miramar",
  name: "Miramar Stays",
  ...
  tagline: "El mar como experiencia",
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#003049", "#0077B6", "#00B4D8", "#CAF0F8"],
  colorEmotion: "Azules mar (Porto Cabana): evasión y libertad mediterránea. NOTA: marca paraguas con 3 sub-marcas de paleta distinta",
  typography: { display: "Cormorant Garamond", text: "Inter", mono: "JetBrains Mono" },
  voice: ["evocador", "exclusivo", "experiencial", "mediterráneo"],
  toneTemperature: "Aspiracional-evocador (5/10 formal)",
  audience: ["Parejas 40-65", "Familias premium", "Viajeros experienciales"],
  contentPillars: ["Destinos y estancias", "Experiencia a bordo / alojamiento", "Gastronomía y eventos", "Ofertas temporada"],
  ...
  dont: ["precio como argumento", "masificación", "genérico"],
  logo: { url: "", description: "Marca paraguas 'Miramar Stays' (razón social Miramar Cruises SL) con 3 sub-marcas: Porto Cabana, Ferrol, Rural Lambre. Assets oficiales (PDF/AI) en '00. CONTEXTO DEL CLIENTE/01. Marca y Brand Assets/Branding/'. Porto Cabana usa paleta azul mar; Ferrol beige; Lambre verde. NOTA: hex exactos pendientes de extraer de los dossieres (PDF imagen).", shape: "Wordmark 'MIRAMAR' + sub-marca. Ver dossieres oficiales por sub-marca.", colors: { primary: "#003049", wave: "#00B4D8", middle: "#0077B6" }, typography: "Cormorant Garamond + Inter (pendiente confirmar con manual)", variants: ["Porto Cabana (azul)", "Ferrol (beige)", "Rural Lambre (verde)"], usage: "Marca comercial: Miramar Stays. Razón social legal: Miramar Cruises SL. Cada sub-marca tiene su paleta." },
  accent: "#0077B6",
  bgGradient: "linear-gradient(135deg, #003049 0%, #0077B6 100%)",
  references: ["Porto Cabana", "Ferrol by Miramar Stays", "Rural Lambre"],
  visualReferences: {
    brands: ["Porto Cabana", "Ferrol by Miramar Stays", "Rural Lambre"],
  ...
  projects: 6, activeBoardId: null,
  verticals: ["SALES","MEDIA"], web: "miramarcruises.es"
},
{
  id: "cl-opositaxd",
  name: "Oposita-XD",
  ...
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#1E1E2E", "#7C3AED", "#A78BFA", "#EDE9FE"],
  colorEmotion: "Púrpura método: estructura mental, disciplina gamificada, confianza",
  typography: { display: "Inter", text: "Inter", mono: "JetBrains Mono" },
  voice: ["motivador", "estructurado", "cercano", "enfocado"],
  toneTemperature: "Motivador-estructurado (5/10 formal)",
  audience: ["Opositores 22-40", "Personas con tiempo limitado", "Segunda oportunidad laboral"],
  contentPillars: ["Método de estudio", "Plazas convocadas", "Testimonios aprobados", "Tiempo de preparación"],
  compositionStyle: "Apuntes y libros de estudio, personas concentradas, contadores tiempo",
  dont: ["ansiedad", "promesas de plaza garantizada", "vaguedad"],
  logo: { url: "", description: "Checkmark ✓ vectorial púrpura #7C3AED, trazo 4pt, esquinas redondeadas, altura 1.3u. Wordmark: 'OPOSITA' en Inter Black caps + '-XD' en Inter ExtraLight lila #A78BFA. Contraste bold/light refuerza método+diversión. ✓ standalone como badge de logro.", shape: "✓: ángulo 45°/30°, trazo radius 3pt. OPOSITA caps bold. -XD mismo baseline lighter. Ratio ✓/texto 1.3:4.5.", colors: { primary: "#7C3AED", light: "#A78BFA", background: "#1E1E2E" }, typography: "Inter Black (OPOSITA) + Inter ExtraLight (-XD)", variants: ["checkmark+wordmark horizontal", "checkmark encima wordmark", "solo ✓ badge"], usage: "-XD siempre en lighter weight. ✓ nunca relleno sólido — siempre trazo. Mínimo 20px." },
  accent: "#7C3AED",
  bgGradient: "linear-gradient(135deg, #1E1E2E 0%, #7C3AED 100%)",
  references: ["opomania.net", "opositatest.com", "tusclases.es"],
  visualReferences: {
    brands: ["OpoMania", "Oposita Test", "Tusclases"],
    ...
    instagramRefs: ["@opomania_es", "@opositatest", "@tusclases_es"],
  ...
  projects: 5, activeBoardId: null,
  verticals: ["SALES","MEDIA"], web: "opositaxd.es"
},
{
  id: "cl-siete",
  ...
  contact: { name: "Vincent Piñón", email: "vincent@cliender.com", role: "Lead Account Manager" },
  palette: ["#1A1A1A", "#F5BC18", "#2B2B2B", "#FFFFFF"],
  colorEmotion: "Amarillo mostaza sobre gris carbón: cercanía accesible + solidez institucional",
  typography: { display: "Raleway", text: "Inter", mono: "JetBrains Mono" },
  voice: ["accesible", "directo", "institucional", "orientado a resultados"],
  toneTemperature: "Directo-accesible en formaciones · ejecutivo-consultoría en ECIA (5/10 formal)",
  audience: ["Desempleados zona Moaña/Vigo (~80km) — formaciones coste cero", "Decisores RRHH y CEO de empresas +100 empleados (ECIA Mapa Conductual B2B)"],
  contentPillars: ["Formaciones coste cero", "Inserción y resultado tangible", "ECIA: intervención organizacional", "Jornadas y plazas limitadas"],
  ...
  dont: ["ECIA: nunca 'curso'/'alumnos'/'aula'", "Formaciones: nunca 'gratis' (usar 'coste cero')", "AI-purple o pink", "stock con sonrisa forzada"],
  logo: { url: "", description: "Marca paraguas El Siete Formación: círculo amarillo mostaza con un '7' estilizado en su interior; wordmark 'el sie7e' con el 7 en amarillo. Claim 'Tu Consultoría de formación y desarrollo'. Sub-marca separada ECIA Mapa Conductual tiene logo propio (brújula con 4 colores de perfil conductual).", shape: "Círculo amarillo mostaza con '7' estilizado centrado. Wordmark 'el sie7e' con el 7 destacado en amarillo.", colors: { primary: "#F5BC18", dark: "#1A1A1A" }, typography: "Raleway", variants: ["logo-el-siete-positivo-negativo", "logo-el-siete-negativo (SVG/PNG)"], usage: "Assets oficiales en '00. CONTEXTO DEL CLIENTE/01. Marca y Brand Assets/logos/'. Logos institucionales Xunta/SEPE/Gobierno en franja inferior, safe zone 140px mínimo." },
  accent: "#F5BC18",
  bgGradient: "linear-gradient(135deg, #1A1A1A 0%, #2B2B2B 100%)",
  references: ["elsieteformacion.com"],
  visualReferences: {
    brands: ["El Siete Formación (marca paraguas)", "ECIA Mapa Conductual (sub-marca B2B)"],
  ...
  projects: 4, activeBoardId: null,
  verticals: ["MEDIA"], web: "elsieteformacion.com"
}];
